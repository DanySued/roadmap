...
import RoadmapView from "@/components/fitpath/RoadmapView";
...
export default async function PathDetailPage({ params }: Props) {
  ...
  const hasRoadmap = !!(pathDetail?.roadmapStages?.length);
      ...
      <main style={{ minHeight: "100vh" }}>
        {hasRoadmap ? (
          <RoadmapView
            ...
            stages={pathDetail.roadmapStages!}
            roadmapMeta={pathDetail.roadmapMeta!}
          />
        ) : (
          <>
            {/* Header */}
